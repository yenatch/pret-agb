...
"""Pokemon Emerald event script commands.
"""
...
event_commands = {
    ...
    0x27: { 'name': 'waitstate',
        'end': True, # only sometimes an ender, but the conditions are unknown. the solution might involve following warps and evaluating their map scripts
        'param_names': [],
        'param_types': [],
        'aliases': ['waitstate'],
    ...
    0x39: { 'name': 'warp',
        'param_names': ['bank', 'map', 'warp', 'X', 'Y'],
        'param_types': ['byte', 'byte', 'byte', 'word', 'word'],
        'aliases': ['warp'],
    ...
    0x50: { 'name': 'movecoords',
        'param_names': ['variable', 'movements'],
        'param_types': [WordOrVariable, MovementPointer],
    ...
    0x79: { 'name': 'givepokemon',
        ...
        'param_types': ['word', 'byte', 'word', 'long', 'long', 'byte'],
    ...
    0xd4: { 'name': 'storeitems',
        'param_names': ['out', 'item', 'quantity'],
        'param_types': ['byte', 'word', 'word'],
    ...
    0xd7: { 'name': 'warp7',
        'param_names': ['byte1', 'byte2', 'byte3', 'word1', 'word2'],
        'param_types': ['byte', 'byte', 'byte', 'word', 'word'],
        'aliases': ['warp7'],
    },
    0xd8: { 'name': 'event_d8',
    ...
    0xe2: { 'name': 'storeitems2',
        'param_names': ['byte', 'word1', 'word2'],
        'param_types': ['byte', 'word', 'word'],
        'aliases': ['bufferitems', 'storeitems'],
    },
}
...
class EventCommand_trainerbattle(Command):
    ...
    description = 'If the Trainer flag for Trainer index is not set, this command does absolutely nothing.'
    aliases = ['trainerbattle']
    param_classes = [Byte] + [Byte, Word, Word,]
    def parse(self):
        Command.parse(self)
        self.param_classes = list(self.param_classes)
        type_ = self.chunks[1].value
        if type_ != 3:
